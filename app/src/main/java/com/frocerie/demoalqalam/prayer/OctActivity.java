...
public class OctActivity extends AppCompatActivity implements VolleyResponse {

    private static final String url_main = "http://alqalamtrust.com/prayer_time/";

    private static final String url = url_main + "/" + "oct";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        touchImageView = (ImageView) findViewById(R.id.ivOctTouch);
        RequestClass.callgetMethod(url,this);
        touchImageView.setVisibility(View.VISIBLE);


        /*recyclerView = (RecyclerView) findViewById(R.id.recyclerImageOct);

        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(OctActivity.this));
    ...
    /*private void loadRecyclerViewData() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(OctActivity.this);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(OctActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(i == R.id.home){
            ...
            NavUtils.navigateUpFromSameTask(OctActivity.this);
